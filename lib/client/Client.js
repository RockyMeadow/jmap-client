...
export default class Client {
  ...
  getMailboxes(options) {
    return this._jmapRequest('Mailbox/get', options);
  }
  ...
  setMailboxes(options) {
    return this._jmapRequest('Mailbox/set', options);
  }
  ...
  getMessageList(options) {
    return this._jmapRequest('Email/query', options);
  }
   ...
   */
  getMessages(options) {
    return this._jmapRequest('Email/get', options);
  }
  ...
  _jmapRequest(method, options) {
    return this.transport
      .post(this.apiUrl, this._defaultHeaders(), {
        using: [
          'urn:ietf:params:jmap:core',
          'urn:ietf:params:jmap:mail'
        ],
        methodCalls: [[ method, options, '0' ]]
      })
      .then(data => Utils.assertValidJMAPResponse(method, data.methodResponses))
